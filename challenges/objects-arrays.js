...
const tyrannosaurus = new Dinosaur({name: 'Tyrannosaurus', diet: 'Carniverous', weight: 7000, length: 12, period: 'Late Cretaceous'});
const stegosaurus = new Dinosaur({name: 'Stegosaurus', diet: 'Herbivorous', weight: 2000, length: 9, period: 'Late Jurassic'});
const velociraptor = new Dinosaur({name: 'Velociraptor', diet: 'Carniverous', weight: 15, length: 1.8, period: 'Late Cretaceous'});
